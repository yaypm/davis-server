...
Slack configured in Davis
Configuring Dynatrace to push problem notifications

1. login to https://signin.dynatrace.com
...
7. Replace the custom JSON payload section with:  { "PID":"{PID}", "ProblemID":"{ProblemID}", "State":"{State}", "ProblemImpact":"{ProblemImpact}", "ProblemURL":"{ProblemURL}", "ImpactedEntity":"{ImpactedEntity}", "Tags":"{Tags}" } 

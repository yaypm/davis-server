...
class Davis {
  ...
  run() {
    ...
    return BbPromise.resolve()
      ...
      .then(n => this.logger.debug(`Loaded ${n} core plugins`))
      .then(() => this.pluginManager.loadUserPlugins(this.userPlugins))
      .then(n => this.logger.debug(`Loaded ${n} user plugins`))
      .then(() => this.logger.info('Training the NLP model'))

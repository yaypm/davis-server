...
class Davis {
  ...
  run() {
    ...
    return BbPromise.resolve()
      ...
      .then(() => this.dynatrace.getApplicationEntities())
      .then(applications => this.pluginManager.setApplicationEntities(applications))
      .then(() => this.dynatrace.getServiceEntities())
      .then(services => this.pluginManager.setServiceEntities(services))
      .then(() => {

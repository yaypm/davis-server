...
class UserActivity {
  ...
  appResponse(exchange, data, app) {
    ...
    templates.show = message.addCard(this.appShow(exchange, data, eId)).slack();
  ...
  noAppResponse(exchange, data) {
    ...
    const show = this.appShow(exchange, data, bigApp);
  ...
  appShow(exchange, data, eid) {
    ...
    imgCard
      .addTitle(['User Activity for', name])
      .setImageURL('http://www.excel-easy.com/data-analysis/images/charts/column-chart.png');

...
module.exports = [
  ...
  { tense: 'future', problems: 0, filtered: true, output: { template: 'future/filtered', followUp: false } },
  { tense: 'future', problems: 1, filtered: true, output: { template: 'future/filtered', followUp: false } },
  { tense: 'future', problems: 2, filtered: true, output: { template: 'future/filtered', followUp: false } },
  { tense: 'future', problems: 3, filtered: true, output: { template: 'future/filtered', followUp: false } },
];

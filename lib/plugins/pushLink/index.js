    ...
    if (_.isNil(choice)) {
      if (vrp) {
        ...
        return BbPromise.all([
          ...
          return exchange.response(`Okay, here is your Dynatrace SmartScape.  Currently, it includes ${numOfApps} ${app} consisting of around ${numOfServices} ${service} across ${numOfHosts} ${host}!`);
        });
      } else if (dynatrace) {

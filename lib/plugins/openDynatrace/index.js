...
class OpenDynatrace {
  ...
  openDynatrace(exchange, pid, context) {

    const response = {
      success: "Okay, no problem, here's your Dynatrace dashboard.",
      failure: "I can show you your Dynatrace dashboard but first you'll need to download the davis Chrome Extension and connect to davis with it. Look for a download link under the Chrome section in davis' Account Settings."
    };

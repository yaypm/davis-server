...
module.exports = [
    ...
    { tense: 'present', containsRootCause: false, eligibleToShow: false, notification: true, output: 'notification' },
    { tense: 'present', containsRootCause: true, eligibleToShow: false, notification: true, output: 'notification' },
];

...
class Scalability {
  constructor(davis, options) {
    ...
    this.intents = {
      scalability: {
        usage: 'Scalability issues',
        examples: [
          'Are there any capacity issues right now?',
          'Were there any capacity issues yesterday?',
        ],
        phrases: [
    ...
    this.hooks = {
      'scalability:gatherData': this.gatherData.bind(this),
      'scalability:decide': this.decide.bind(this),
      'scalability:scalability': this.scalability.bind(this),
    };
  }

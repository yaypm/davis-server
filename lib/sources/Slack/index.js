...
class Slack {
  ...
  init() {
    ...
    if (!this.davis.config.getSlackEnabled()
    ...
    controller.webserver = require('../../routes/api/slack');
    ...
    controller.hears(['(.*)'], 'direct_mention,direct_message', (bot, message) => {
        ...
        if(message.text.startsWith('You have been removed from')) {
            ...
            this.logger.info('Oh no!  Davis was removed from a channel!');
                ...
                bot.identifyBot( (err, response) => {
                    ...
                    bot.api.users.info( {user: response.id}, (err, response) => {
                        ...
                        bot.startConversation(message, (err, convo) => {
                            let slackConvo = new SlackConversation();

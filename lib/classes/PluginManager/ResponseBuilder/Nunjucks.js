...
class Nunjucks {
  constructor(davis) {
    ...
    this.env.addFilter('buildProblemUrl',
        davis.textHelpers.buildProblemUrl.bind(davis.textHelpers));

    this.env.addFilter('buildProblemsUrl',
        davis.textHelpers.buildProblemsUrl.bind(davis.textHelpers));

    this.env.addFilter('buildEventUrl',
        davis.textHelpers.buildEventUrl.bind(davis.textHelpers));

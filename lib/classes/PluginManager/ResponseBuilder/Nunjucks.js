...
class Nunjucks {
  constructor(davis) {
    ...
    this.env.addFilter('buildProblemUrl',
        problem =>
          davis.textHelpers.buildProblemUrl(problem));

    this.env.addFilter('buildProblemsUrl',
        (problems, timeRange) =>
          davis.textHelpers.buildProblemsUrl(problems, timeRange));

    this.env.addFilter('buildEventUrl',
        (problem, event) =>
          davis.textHelpers.buildEventUrl(problem, event));

    this.env.addFilter('toTitleCase', davis.textHelpers.toTitleCase);

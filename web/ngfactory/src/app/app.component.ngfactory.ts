...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  _RouterOutlet_5_5:import9.Wrapper_RouterOutlet;
  _text_6:any;
  _el_7:any;
  _text_8:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._vc_5 = new import8.ViewContainer(5,(null as any),this,this._el_5);
    this._RouterOutlet_5_5 = new import9.Wrapper_RouterOutlet(this.parentView.injectorGet(import10.RouterOutletMap,this.parentIndex),this._vc_5.vcRef,this.parentView.injectorGet(import11.ComponentFactoryResolver,this.parentIndex),(null as any));
    this._text_6 = this.renderer.createText(parentRenderNode,'\n\n',(null as any));
    this._el_7 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray2(2,'id','made-in-detroit'),(null as any));
    this._text_8 = this.renderer.createText(this._el_7,'Made in Detroit',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import12.RouterOutlet) && (5 === requestNodeIndex))) { return this._RouterOutlet_5_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {

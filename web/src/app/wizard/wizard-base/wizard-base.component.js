...
// Class
// ----------------------------------------------------------------------------
var WizardBaseComponent = (function () {
    // ------------------------------------------------------
    // Inject services
    // ------------------------------------------------------
    function WizardBaseComponent(iConfig, iDavis) {
    ...
    WizardBaseComponent = __decorate([
        ...
        __metadata('design:paramtypes', [config_service_1.ConfigService, davis_service_1.DavisService])
    ], WizardBaseComponent);
    return WizardBaseComponent;
}());
exports.WizardBaseComponent = WizardBaseComponent;
//# sourceMappingURL=wizard-base.component.js.map